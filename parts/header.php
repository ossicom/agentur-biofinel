...
<header class="page-header">
    <div class="container">
        <nav class="navbar navbar-expand-md navbar-dark">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <?php foreach($navigation AS $key => $value): ?>
                    <a class="nav-item nav-link<?php if($key == "#"): ?> active<?php endif;?>"
                        href="<?php echo e($key); ?>">
                        <?php echo e($value); ?>
                        <?php if($key == "#"): ?>
                        <span class="sr-only">(current)</span>
        ...
        <div
            ...
            <h1 class="display-4">Responsive Webdesign!</h1>
            <h2 class="display-5">Herzlich Willkommen!</h2>
            <h3 class="display-6">Wir entwickeln Webseiten</h3>
